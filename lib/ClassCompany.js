...
class Company {
    ...
    createOppyWonQuarter(quarter) { this.oppyWon[quarter]=[]}
    addOppyWon(quarter, oppyID) { this.oppyWon[quarter].push(oppyID)}
    competeOnOpportunity(oppy){
        let join=true;
