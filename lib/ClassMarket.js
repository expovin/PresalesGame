    ...
    nextPeriod(){
        ...
        this.Opportunities.forEach( oppy => {
            Object.keys(this.Companies).forEach(companyID => {  
                ...
                var gonnaCompete=_this.Companies[companyID].competeOnOpportunity(oppy);
                if(gonnaCompete){
            ...
            if(winner !== null){
                ...
                this.Companies[winner].addOppyWon(this.quarter, oppy.getID())
                this.Companies[winner].cashIn(oppy.getRealValue())
                this.Companies[winner].sendMessage("Congratulation, you won the oppy ID "+oppy.getID()+" for a real valu of "+oppy.getRealValue());
            }
